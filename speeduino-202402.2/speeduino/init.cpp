...
void setPinMapping(byte boardID)
{
  ...
  switch (boardID)
  {
   ...
   case 31:
      //Pin mappings for the Spark EFI V1.1 by www.sparkefi.net
      #if defined(CORE_AVR)
      ...
      pinVVT_2 = 44; //VVT2 output (exhaust vanos) > Board Output Name SPARE.1
      ...
      pinSpareHOut1 = 3; // high current output spare1 > Board Output Name N2O.1
      pinSpareHOut2 = 53; // high current output spare2 > Board Output Name N2O.2

      //Spare Analog In.1 = A9
      //Spare Analog In.1 = A10

      //Spare Digital In.1 = D23
